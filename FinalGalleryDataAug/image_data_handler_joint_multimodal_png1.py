...
class ImageDataHandler(object):
    ...
    def _read_txt_file(self, txt_file, data_dir):
        ...
        for path in img_paths:
            img_paths_rgb.append(data_dir + path + '_rgb.png')  # + "rgbcrop.png")      #cambiato
            img_paths_depth.append(data_dir + path + '_depth.png')  # + "depthcrop.png")
    ...
    def _create_dataset(self):
        ...
        if self.augmentation:
            augmentations = [self._prepare_input_rot90, self._prepare_input_rot180, self._prepare_input_rot270, self._prepare_input_hflip, self._prepare_input_vflip]
