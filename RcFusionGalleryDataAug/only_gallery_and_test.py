...
#dataset_root_dir = "D:/DATASET/DatasetGennFebb_staffRiunito_v_finale/finale/" #staff riunito
...
# todo occhio ai file
                                    #0_realshop_500id_10f_gallery5 0_realshop 250id_20foto_gallery5
test_file = dataset_test_dir + '0_100id_50frame_10g/test.txt'
gallery_file = dataset_train_dir_rgb + '0_100id_50frame_10g/gallery.txt'
...
for hp in set_params:
    ...
    init_op_rgb = {'testing': testing_init_op,
                   'gallery': gallery_init_op}
    batches_per_epoch = {'testing': test_batches,
    ...
    with tf.Session(config=config) as sess:
        ...
        #loss = factory_scale_loss*(loss_cls + loss_l2) + tloss
        loss = factory_scale_loss*(loss_cls) + tloss
