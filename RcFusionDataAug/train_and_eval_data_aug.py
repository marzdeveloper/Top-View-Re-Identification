...
# Data-related params
dataset_root_dir = "/content/drive/My Drive/TVPR2/"
...
# todo occhio ai file
train_file = dataset_train_dir_rgb + '0gallery_200_id/train.txt'
val_file = dataset_val_dir_rgb + '0gallery_200_id/val.txt'
test_file = dataset_test_dir + '0gallery_200_id/test.txt'
...
simpleLog = "/content/drive/My Drive/RCFusionFinal/log.txt"
...
for hp in set_params:
    ...
    tr_data = ImageDataHandler(
        ...
        shuffle=True,
        random_crops=False, augmentation=True)
        ...
        for epoch in range(num_epochs):
            ...
            if (epoch + 1) % 1 == 0:
                ...
                if val_loss < best_loss_val:
                    best_saver.save(sess, "/content/drive/My Drive/Model/model.ckpt")
