...
# Data-related params
#dataset_root_dir = "D:/DATASET/mese/preprocessed/"

dataset_root_dir = "C:/Users/Daniele/Desktop/50_id/mese/preprocessed/"
...
train_file = dataset_root_dir + '/train.txt'
val_file = dataset_root_dir + '/test.txt'
...
# Checkpoint dir
checkpoint_dir = "C:/Users/Daniele/Desktop/50_id/mese/"
...
for hp in set_params:
    ...
    with tf.Session() as sess:
        ...
        # F2-norm
        # rgb_nodes = [relu_conv1x1_inter_res2_rgb, relu_conv1x1_res2_rgb, relu_conv1x1_inter_res3_rgb, relu_conv1x1_res3_rgb,
        # relu_conv1x1_inter_res4_rgb, relu_conv1x1_res4_rgb, relu_conv1x1_inter_res5_rgb, relu_conv1x1_res5_rgb]
        ...
        # depth_nodes = [relu_conv1x1_inter_res2_depth, relu_conv1x1_res2_depth, relu_conv1x1_inter_res3_depth,
        # relu_conv1x1_res3_depth, relu_conv1x1_inter_res4_depth, relu_conv1x1_res4_depth, relu_conv1x1_inter_res5_depth, relu_conv1x1_res5_depth]
        ...
        #todo modifica1 commentare trainsteprgb e depth , dentro with scambiare train step
        train_step_rgb = tf.keras.optimizers.RMSprop(lr=decayed_lr * lr_mult_conv1x1).get_updates(loss=loss,params=trainable_variables_rgb)
        train_step_depth= tf.keras.optimizers.RMSprop(lr=decayed_lr * lr_mult_conv1x1).get_updates(loss=loss, params=trainable_variables_depth)
        train_step = tf.group(train_step_rnn, train_step_conv1x1,train_step_rgb,train_step_depth, increment_global_step)
